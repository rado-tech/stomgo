...
/** Klinika paneli — bemorlar bilan yozishuv */
export default function ClinicChatsPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl">
      <h1 className="mb-1 text-xl font-extrabold">Bemorlar bilan yozishuv</h1>
      <p className="mb-4 text-[13px] text-zinc-500">
        Barcha muloqot ilova ichida — bemor uchun ham, siz uchun ham xavfsiz.
        Tashqi kanallardagi kelishuvlarga platforma javobgar emas.
      </p>

      {items.length === 0 ? (
        <EmptyState icon="💬" title="Hali xabar yo'q" subtitle="Bemorlar savol yozganda shu yerda ko'rinadi" />
      ) : (
        <div className="grid gap-4 md:grid-cols-[300px_1fr]">
          ...
          <div className="min-h-[420px] overflow-hidden rounded-2xl border border-zinc-100 bg-white md:h-[70vh]">
            {active ? (
              ...
              <EmptyState icon="👈" title="Suhbatni tanlang" subtitle="Chapdagi ro'yxatdan bemorni tanlang" />
            )}
          </div>
        </div>
      )}

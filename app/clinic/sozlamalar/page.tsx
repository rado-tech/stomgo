  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <div className="space-y-4">
        ...
        <section className="rounded-2xl border border-zinc-100 bg-white p-4">
          <h2 className="mb-2 font-bold">Check-in kodi</h2>
          <p className="text-[13.5px] text-zinc-500">
            Resepshn stoliga qo&apos;yiladigan kod: <b className="font-mono text-lg text-teal-800">{p.checkinCode}</b>
          </p>
          <button onClick={() => save({ regenerateCheckinCode: true })} className="mt-2 rounded-xl border border-zinc-200 px-4 py-2 text-[13px] font-semibold">
            Yangi kod yaratish
          </button>
        </section>

...
export const ru: Record<keyof typeof uz, string> = {
  ...
  "prices.searchPlaceholder": "Название услуги: имплант, пломба, брекеты...",
  "prices.notFound": "Услуга не найдена",
  "partner.title": "Добавьте вашу клинику в StomGo",
  "partner.b1": "Пациент найдёт вас сам",
  "partner.b1d": "Вас видно на карте, в поиске по цене и по вашему району",
  "partner.b2": "Записи в одном месте",
  "partner.b2d": "Приёмы, переписка и отзывы — в одной панели",
  "partner.b3": "Начать бесплатно",
  "partner.b3d": "За подключение платить не нужно",
  "partner.clinicName": "Название клиники",
  "partner.district": "Район",
  "partner.choose": "Выберите",
  "partner.doctorCount": "Количество врачей",
  "partner.address": "Адрес",
  "partner.addressPlaceholder": "Улица, дом",
  "partner.contactName": "Контактное лицо",
  "partner.note": "Дополнительно",
  "partner.notePlaceholder": "Часы работы, специализации или ваш вопрос",
  "partner.submit": "Отправить заявку",
  "partner.sending": "Отправляется...",
  "partner.sentTitle": "Заявка принята",
  "partner.sentBody": "Мы свяжемся с вами по указанному номеру в течение рабочего дня. После разговора вы получите логин и пароль для панели.",
